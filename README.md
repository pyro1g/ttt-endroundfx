...
| `endroundfx_respawn_give_weapon`    | `1`                  | Gives a weapon to anyone who has no pistol or heavy weapon, one second after respawning so pointshop/loadout guns go first. Also fills that weapon's reserve ammo |
